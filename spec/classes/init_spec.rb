    ...
    on_supported_os.each do |os, facts|
      context "on #{os}" do
        ...
        context "dummy class with selinux enabled" do
          ...
          it { is_expected.to contain_class('dummy::config::selinux').that_comes_before('dummy::service') }
        ...
        context "dummy class with auditing enabled" do
          ...
          it { is_expected.to contain_class('dummy::config::auditing').that_comes_before('dummy::service') }
        ...
        context "dummy class with logging enabled" do
          ...
          it { is_expected.to contain_class('dummy::config::logging').that_comes_before('dummy::service') }
